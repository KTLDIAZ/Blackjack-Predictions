  ...
  praseOutputs(outputs) {
    ...
    for (var outs in outputs) {
      ...
      if ("name" in outputs[outs]) {
        for (var texto in outputs[outs]["text"]) {
          stdout += outputs[outs]["text"][texto];
        }
        stdout_found = true;
                      ...
                      <Col span={this.state.gutterVisible ? 3 : 1}>
                        ...
                        >
                          <Typography.Text
                            style={{
                              color:
                                this.state.background_text_theme || "56ACBC",
                              float: "left",
                              padding: "5px",
                              display:
                                item["cell_type"] === "code" ? "" : "none",
                            }}
                          >
                        ...
                        <Col span={this.state.gutterVisible ? 3 : 1}>
                          <Typography.Text
                            style={{
                              display: this.state.gutterVisible ? "" : "none",
                              color:
                                this.state.background_text_theme || "E5496A",
                              float: "left",
                              padding: "5px",
                            }}
                          >
